...
document.addEventListener('DOMContentLoaded', function () {
    fetch('/php/fetch_stories_projects.php')
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
            ...
            data.projects.forEach(project => {
                ...
                <a href="details.html?id=${project.id}" class="image-link">
                        <img src="/uploads/${project.image}" alt="Work by ${project.artist}">
                    </a>
                    <div class="details">
